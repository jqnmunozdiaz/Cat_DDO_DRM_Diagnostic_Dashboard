...
def get_input_section():
    ...
    return html.Div([
        ...
        html.Div([
            ...
            html.Div([
                html.H3("The DRM policy framework: pillars and thematic areas", className="mb-3", style={"fontSize": "1.4rem"}),
        ...
        html.Div([
            html.P([
                ...
                ". Within each thematic area, questions follow the results chain logic used in Development Policy Financing (DPF) operations, progressing from policy and institutional inputs, through reform implementation, to outputs and outcomes that contribute to strengthened disaster resilience. Users should review official documentation (legal, regulatory, institutional, and budgetary) and report sources in the “Sources” column, including where possible, electronic links to supporting documents to enhance transparency and robustness. While some questions can be addressed through desk review, others may require consultations with colleagues and national authorities. This is particularly relevant for cross-cutting questions, where inputs from colleagues from sectors such as Water, Transport, Education, Health, and Agriculture may help in gathering information."
            ], className="text-muted"),
            html.P([
