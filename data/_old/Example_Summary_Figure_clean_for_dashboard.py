...
# Load CSV data
# Allow passing input and output paths as command-line arguments
input_csv = sys.argv[1] if len(sys.argv) > 1 else "DRM_system_assessment_template_filled_example.csv"
output_png = sys.argv[2] if len(sys.argv) > 2 else "DRM_Assessment_Chart.png"
...
for col in value_cols:
    df_raw[col] = pd.to_numeric(df_raw[col].astype(str), errors='coerce', downcast='float')
